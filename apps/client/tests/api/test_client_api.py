...
# class ClientAPITest(test.APITestCase, ClientBaseTest):
...
#     def test_client_teacher_api_delete_return_status_code_204_no_content(self): # noqa: E501
#         self.create_superuser()
#         teacher = self.create_teacher()
...
#     def test_client_teacher_api_delete_return_status_code_401_forbidden(self): # noqa: E501
#         data_user = {'username': 'UserApi', 'password': 'Pass'}
#         self.create_user(**data_user)
...
#     def test_client_teacher_api_not_logged_patch_return_status_code_401(self): # noqa: E501
#         url = reverse('client:teacher-api-detail', args=(1,))
#         response = self.client.patch(url)

#         self.assertEqual(status.HTTP_401_UNAUTHORIZED, response.status_code)

#     def test_client_teacher_api_not_logged_delete_return_status_code_401(self): # noqa: E501
#         url = reverse('client:teacher-api-detail', args=(1,))
